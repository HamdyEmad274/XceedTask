...
{
    public class ProductRepository : IRepository.IRepository, IProduct
    {
        private readonly XceedDbContext db;
        private readonly IWebHostEnvironment webHost;
        public ProductRepository(XceedDbContext _db, IWebHostEnvironment _webHost)
        {
            db = _db;
